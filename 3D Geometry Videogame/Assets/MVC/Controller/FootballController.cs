...
public class FootballController
{
    ...
    {
        return MissionListController.Instance.GetCurrentMissionPlayer().GetFootball().GetFiguresInWaves();
    }
    ...
    {
        MissionListController.Instance.GetCurrentMissionPlayer().GetFootball().SetFiguresInWaves(waveCubes);
